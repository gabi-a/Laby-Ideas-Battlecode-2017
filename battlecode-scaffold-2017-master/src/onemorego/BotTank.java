...
public class BotTank {
	...
	static final float attackRotAngle = (float) (2*Math.atan(RobotType.TANK.bodyRadius/attackRadius));
	...
	public static void turn(RobotController rc) throws GameActionException {
		...
		case OFFENSE:
			...
			if(closestEnemy != null) {
				...
				if(myLocation.distanceTo(closestEnemy.location) < RobotType.TANK.bodyRadius + closestEnemy.type.bodyRadius + 0.3f) {
			...
			if(closestEnemy != null) {
				...
				*/
				...
				if(gardenProtectionLocation != null) {
					if(myLocation.distanceTo(gardenProtectionLocation) > RobotType.TANK.sensorRadius - 2f) {
